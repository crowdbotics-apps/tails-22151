...
admin.site.site_header = "Tails"
admin.site.site_title = "Tails Admin Portal"
admin.site.index_title = "Tails Admin"

# swagger
api_info = openapi.Info(
    title="Tails API",
    default_version="v1",
    description="API documentation for Tails App",
)
